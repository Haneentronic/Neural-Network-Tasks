...
class MultiLayerPerceptron:
    def __init__(self, num_inputs, hidden_layers, num_outputs, activation):
...
activation1 = "sigmoid"
activation2 = "tanh"
mlp = MultiLayerPerceptron(5, [3 , 5], 3, activation1)
...
mlp.train(INPUTS, OUTPUTS, 30, 0.5, 1)
...
train_prediction = converter(train_prediction)
...
test_prediction = converter(test_prediction)
correct_classified = 0
